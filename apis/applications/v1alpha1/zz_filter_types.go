...
type FilterParameters_2 struct {
	...
	// +kubebuilder:validation:Optional
	RelationVzRsFiltGraphAtt *string `json:"relationVzRsFiltGraphAtt,omitempty" tf:"relation_vz_rs_filt_graph_att,omitempty"`

	// +kubebuilder:validation:Optional
	RelationVzRsFwdRFltPAtt *string `json:"relationVzRsFwdRFltPAtt,omitempty" tf:"relation_vz_rs_fwd_r_flt_p_att,omitempty"`

	// +kubebuilder:validation:Optional
	RelationVzRsRevRFltPAtt *string `json:"relationVzRsRevRFltPAtt,omitempty" tf:"relation_vz_rs_rev_r_flt_p_att,omitempty"`
